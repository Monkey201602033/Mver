...
namespace WindowsFormsApp1
{
    public class DHCameraCtrl
    {
        ...
        List<IGXDeviceInfo> m_listGXDeviceInfo = new List<IGXDeviceInfo>();   // 枚举出所有设备
        ...
        IFrameData m_objIFrameData = null;
        public DHCameraCtrl()
        {
            try
            {
        ...
        public IFrameData GetImage()
        {
            return m_objIFrameData;
        }
        ...
        {
            Mat mat = IFrameData2Mat(objIFrameData, m_nWidth, m_nHeight);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public int EnumDevices(ref string[] sDeviceName)
        {
            try
            {
